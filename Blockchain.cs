...
namespace InfoCoin
{
    class Blockchain
    {
        ...
        {
            //new block is getting the hash from the previous block to link them
        ...
        //a wallet represents the sum of all its transactions
        ...
        public bool IsChainValid()
        {
            for (int i = 1; i < this.Chain.Count; i++)
            {
                ...
                //Check if the current block hash is same as the calculated hash
